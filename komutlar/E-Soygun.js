  ...
  if (crime !== null && timeout - (Date.now() - crime) > 0) {
    ...
    message.channel.send(
      new Discord.MessageEmbed()
        ...
        .setDescription(`⏱ Soygun yapmak için ${
    ...
    const cümleler = [
      "Soygun bittikten sonra polis seni yakaladı",
      'Masken yırtıldı, ifşa oldun',
      "Tofaş çalarken yaşlı amca seni yakaladı",
      "Marketi soyarken kekolar seni patakladı",
      "Boksör adamı soymaya çalışırken dayak yedin",
      'Kekolar seni bankayı soyup kaçarken yakaladı',
      "Tofaşı çalarken alarm öttü"
    ];
    ...
    if (awnser === "LOOSELOOSE") {
      ...
      const sentences2 = [
        "Ünlü bir iş adamını soydun",
        "Şehirdeki bir süpermarketi soydun",
        "Mahalledeki dayının tofaşını çaldın",
        "Galeri soygunu yaptın",
        'Nokia çalıp birisine sattın',
        "Tofaş çaldın"
      ];
